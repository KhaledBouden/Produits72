...
class Produit
{
    ...
    #[Vich\UploadableField(mapping: 'produit_images', fileNameProperty: 'imageName', size: 'imageSize')]
    ...
    {
        return $this->getTitre(); // Assuming you have a getTitle() method in your entity
    }
}
